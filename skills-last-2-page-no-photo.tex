...
\begin{itemize}
  ...
  \item Built a content versioning system that let admins publish, update, and archive without impacting live content, reducing publishing errors by \textasciitilde{}25\% and eliminating rollback downtime.
...
\end{itemize}
\emph{PHP, JavaScript, jQuery, Bootstrap, MySQL}
