...
\begin{itemize}
  ...
  \emph{Laravel, PHP, AWS Chime, Kinesis, S3, EC2, Route53, Apache, WebRTC}
  ...
  \emph{TypeScript, Express.js, Next.js, MySQL, PM2, Nginx, DigitalOcean}
